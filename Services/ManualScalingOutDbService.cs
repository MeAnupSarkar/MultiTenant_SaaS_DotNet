...
{
    public class ManualScalingOutDbService
    {
        ...
        public ManualScalingOutDbService(ApplicationDbContext context, SharedCatalogDbContext contextSharedDb, IConfiguration config)
        {
            _context = context;
